...
tf.app.flags.DEFINE_string('data_dir', pt.expanduser('LSP_data/'),
                           """Folder for downloading and extracting data.""")
tf.app.flags.DEFINE_string('orimage_dir', pt.expanduser('LSP_data/images/'),
                           """Folder for saving resized train files""")
tf.app.flags.DEFINE_string('train_dir', pt.expanduser('LSP_data/TrainData'),
                           """Folder for saving train files""")
tf.app.flags.DEFINE_string('input_dir', pt.expanduser('LSP_data/EvalData/'),
                           """Input images directory.""")
tf.app.flags.DEFINE_string('output_dir', pt.expanduser('LSP_data/EvalData/Drawings'),
                           """Output images directory.""")
tf.app.flags.DEFINE_string('drawing_dir', pt.expanduser('LSP_data/TrainData/Drawings'),
                           """Folder for saving train files""")
